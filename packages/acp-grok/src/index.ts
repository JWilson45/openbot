...
Browser: Navigate (http(s) only) and BrowserSnapshot on the shared desk Chromium — the same window as Takeover. BrowserSnapshot is how you see the page the human is showing. Navigate fails with takeover_active while they are driving. Do not curl pages; use these tools.
